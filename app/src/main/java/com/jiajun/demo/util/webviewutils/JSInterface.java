package com.jiajun.demo.util.webviewutils;
...
import com.jiajun.demo.util.CommonUtils;
...
//        }
    ...
    public void openMobilePhone(String phoneNumber) {
        Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("login_tel:" + phoneNumber));
//        mContext.startActivity(intent);
    }
