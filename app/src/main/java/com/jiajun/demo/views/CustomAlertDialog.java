...
public class CustomAlertDialog {
	...
	public CustomAlertDialog(Context context, int contentViewId) {
		...
		cancel = window.findViewById(R.id.dialog_cancel);
		submit = window.findViewById(R.id.dialog_submit);
		msg_tv = window.findViewById(R.id.dialog_msg);
		msg_title = window.findViewById(R.id.dialog_title);
