 ...
 */
public class CustomerProvinceFragment extends BottomDialogFragment {
    ...
    public static CustomerProvinceFragment getInstance() {
        CustomerProvinceFragment f = new CustomerProvinceFragment();
        return f;
    }
    ...
    protected void initialize(View view, Bundle savedInstanceState) {
        ...
        String[] strs_1 = getResources().getStringArray(R.array.province1);
        String[] strs_2 = getResources().getStringArray(R.array.province2);
        String[] strs_3 = getResources().getStringArray(R.array.province3);
        String[] strs_4 = getResources().getStringArray(R.array.province4);
