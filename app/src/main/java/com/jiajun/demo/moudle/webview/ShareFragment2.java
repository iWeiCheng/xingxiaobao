 ...
 */
public class ShareFragment2 extends BottomDialogFragment implements View.OnClickListener {
    ...
    public static ShareFragment2 getInstance() {
        ShareFragment2 f = new ShareFragment2();
        return f;
    }
    ...
    protected void loadLayout() {
        setContentView(R.layout.share_xct);
    }
