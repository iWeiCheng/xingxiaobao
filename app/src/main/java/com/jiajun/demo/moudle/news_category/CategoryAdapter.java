package com.jiajun.demo.moudle.news_category;
...
import com.jiajun.demo.moudle.news_category.draghelper.OnDragVHListener;
import com.jiajun.demo.moudle.news_category.draghelper.OnItemMoveListener;
...
public class CategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    public CategoryAdapter(Context context, ItemTouchHelper helper, List<CategoryEntity> mMyChannelItems, List<CategoryEntity> mOtherChannelItems) {
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        CategoryEntity item = mMyChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        CategoryEntity item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
