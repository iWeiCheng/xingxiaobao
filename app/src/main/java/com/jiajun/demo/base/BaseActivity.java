...
public abstract class BaseActivity extends FragmentActivity implements IBaseView, OnBqsDFListener {
...
//    }
    ...
    protected void initBqsDFSDK() {
        ...
        BqsDF.setOnBqsDFContactsListener(new OnBqsDFContactsListener() {
            ...
            public void onGatherResult(boolean gatherStatus) {
                Logger.e("通讯录采集状态 gatherStatus=" + gatherStatus);
            }
            ...
            public void onFailure(String resultCode, String resultDesc) {
                Logger.e("通讯录采集失败 resultCode=" + resultCode + " resultDesc=" + resultDesc);
            }
        });
        ...
        params.setPartnerId("minsheng");//商户编号
    ...
    public void onSuccess(String tokenKey) {
        ...
        Logger.e("白骑士SDK采集设备信息成功 tokenkey=" + tokenKey);
    }

    //设备采集失败
    @Override
    public void onFailure(String resultCode, String resultDesc) {
        Logger.e("白骑士SDK采集设备信息失败 resultCode=" + resultCode + " resultDesc=" + resultDesc);
    }
    ...
    public void submitTokenkey() {
        String tokenkey = BqsDF.getTokenKey();
        Logger.e("提交tokenkey:" + tokenkey);
        preferences.edit().putString("tokenkey",tokenkey).apply();
    }

    public void hideIM(View edt, Context activity) {
        try {
